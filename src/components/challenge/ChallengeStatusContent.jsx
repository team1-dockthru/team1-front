...
export default function ChallengeStatusContent({
  bannerText,
  bannerClassName,
  reasonTitle,
  reasonBody,
  ...
  return (
    <div className="flex flex-col gap-6">
      <div
        className={`rounded-full px-6 pt-[8px] pb-[8px] text-center font-14-semibold ${bannerClassName}`}
      >
        {bannerText}
      </div>

      <div className="rounded-2xl border border-[var(--gray-200)] bg-[var(--gray-50)] p-6 text-center">
        <div className="font-14-semibold text-[var(--gray-800)]">{reasonTitle}</div>
        <p className="mt-3 font-14-regular text-[var(--gray-700)]">{reasonBody}</p>
