    ...
    <div className="min-h-screen bg-[var(--gray-50)]">
      ...
      <Container className="py-10 md:py-[60px]">
        <div className="flex flex-col gap-6">
          <div className="rounded-full bg-[#6b6b6b] px-6 pt-[8px] pb-[8px] text-center font-14-semibold text-white">
            삭제된 챌린지입니다.
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="font-14-regular-130 text-[var(--gray-700)]">
          ...
          <div className="border-t border-[var(--gray-200)] pt-4">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-[var(--gray-200)] bg-white">
              <button
                type="button"
                onClick={() => router.push("/wip")}
                className="absolute right-4 top-4 z-10 inline-flex h-8 items-center gap-2 rounded-full bg-[var(--gray-100)] px-3 text-[12px] font-12-medium text-[var(--gray-700)] hover:bg-[var(--gray-200)]"
              >
                링크 열기
              </button>
              <RejectSampleImage className="h-auto w-full" />
            </div>
          </div>
        </div>
      </Container>
