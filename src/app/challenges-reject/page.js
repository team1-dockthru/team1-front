    ...
    <div className="min-h-screen bg-[var(--gray-50)]">
      ...
      <Container className="py-10 md:py-[60px]">
        <div className="flex flex-col gap-6">
          <div className="rounded-full px-6 pt-[8px] pb-[8px] text-center font-14-semibold bg-[#fff1f1] text-[var(--error)]">
            신청이 거절되었습니다.
          </div>

          <div className="rounded-2xl border border-[var(--gray-200)] bg-[var(--gray-50)] p-6 text-center">
            <div className="font-14-semibold text-[var(--gray-800)]">신청 거절 사유</div>
